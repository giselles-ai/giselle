...
CREATE TABLE "stripe_billing_pricing_plan_subscription_histories" (
	"db_id" serial PRIMARY KEY NOT NULL,
	"team_db_id" integer NOT NULL,
...
ALTER TABLE "stripe_billing_pricing_plan_subscription_histories" ADD CONSTRAINT "stripe_billing_pricing_plan_subscription_histories_team_db_id_teams_db_id_fk" FOREIGN KEY ("team_db_id") REFERENCES "public"."teams"("db_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stripe_billing_pricing_plan_subscription_histories" ADD CONSTRAINT "stripe_billing_pricing_plan_subscription_histories_billing_cadence_db_id_stripe_billing_cadence_histories_db_id_fk" FOREIGN KEY ("billing_cadence_db_id") REFERENCES "public"."stripe_billing_cadence_histories"("db_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "stripe_pps_hist_id_idx" ON "stripe_billing_pricing_plan_subscription_histories" USING btree ("id");--> statement-breakpoint
CREATE INDEX "stripe_pps_hist_team_db_id_idx" ON "stripe_billing_pricing_plan_subscription_histories" USING btree ("team_db_id");--> statement-breakpoint
CREATE INDEX "stripe_pps_hist_billing_cadence_db_id_idx" ON "stripe_billing_pricing_plan_subscription_histories" USING btree ("billing_cadence_db_id");