		...
		>
			<div className="flex items-center gap-4">
				...
				<button
					type="button"
					onClick={() => setIsEditModalOpen(true)}
					className="text-primary-100 font-normal text-[16px] font-sans px-3 py-2 rounded-[8px] flex-1 truncate text-left hover:bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 5%,transparent)] focus-visible:outline-none focus-visible:shadow-[0_0_0_1px_var(--color-focused)]"
					style={{
						background: "#00020A",
