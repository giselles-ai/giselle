					...
					<div className="mt-2 flex flex-col items-center gap-6 w-full">
						...
						<div className="w-full">
							<div className="grid gap-1">
								...
								<div
									className={`flex items-center gap-2 rounded-[12px] px-2 py-1 bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 5%,transparent)] focus-within:ring-1 focus-within:ring-primary-100/50 focus-within:ring-inset transition-all ${error ? "ring-1 ring-error-900" : ""}`}
								>
									<Input
										id="displayName"
										name="displayName"
