		...
		>
			...
			<div className="relative flex-1 w-full">
				...
				<Input
					...
					className="pl-12 pr-4 h-10 w-full bg-ghost-element text-text placeholder:text-tabs-inactive-text border-border rounded-[8px] shadow-none focus:border-transparent focus:ring-1 focus:ring-inset focus:ring-offset-0 focus-visible:border-transparent focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-offset-0"
				/>
			</div>
