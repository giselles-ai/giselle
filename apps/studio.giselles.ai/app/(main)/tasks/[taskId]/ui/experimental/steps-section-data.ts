...
import type { UIStepItem } from "./step-item";
import type { StepsSectionData, UIStep } from "./steps-section";

export async function getStepsSectionData(
	taskId: TaskId,
): Promise<StepsSectionData> {
