                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <Button
                      variant="subtle"
                      size="compact"
                      className="w-8 h-8 p-0 text-text-muted hover:text-text transition-colors"
                    >
                      <svg
                        width={24}
                        height={24}
              ...
              {playlist.apps.map((app) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <div className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-ghost-element flex items-center justify-center flex-shrink-0 transition-all group-hover:bg-primary-100/20">
