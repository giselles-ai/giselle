...
export default async function ({
	...
	return (
		<div className="bg-bg text-foreground min-h-screen md:h-screen md:flex md:flex-row font-sans">
			...
			<main className="hidden md:flex m-0 md:my-[8px] md:mr-[12px] flex-1 rounded-none md:rounded-[12px] backdrop-blur-md bg-[color-mix(in_srgb,var(--color-primary-100)_3%,transparent)] border-0 md:border md:border-border shadow-black/10 shadow-inner overflow-hidden">
				{children}
			</main>
		</div>
	);
