					...
					<div className="relative z-10 w-[90vw] max-w-[500px] max-h-[90vh] overflow-y-auto rounded-[12px] p-6 shadow-xl focus:outline-none">
						...
						<div className="mt-4">
							...
							<div className="mb-6">
								...
								<div className="w-full p-3 bg-white/5 border border-border rounded-lg text-inverse text-sm opacity-50">
									Coming Soon
								</div>
							</div>
			...
			<DialogContent>
				...
				<div className="mb-6">
					...
					<select
						id="font-select"
						disabled
						className="w-full p-3 bg-white/5 border border-border rounded-lg text-inverse text-sm opacity-50 cursor-not-allowed"
					>
