  ...
  return (
    <DropdownMenuPrimitive.Root>
      <DropdownMenuPrimitive.Trigger asChild>
        <button
          className="group w-full h-full rounded-md cursor-pointer outline-none p-1.5 flex items-center gap-2"
          type="button"
        >
          ...
          <ChevronRight className="w-3 h-3 ml-auto text-stage-sidebar-text-hover rotate-90 transition-transform duration-200 group-data-[state=open]:-rotate-90" />
        </button>
