		...
		<nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-stage-background)] border-t border-white/10 z-20 h-[60px]">
			...
			{showMobileMenu && (
				<div className="md:hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
					<div className="fixed bottom-0 left-0 right-0 bg-[var(--color-stage-background)] border-t border-white/10 rounded-t-2xl p-6 animate-in slide-in-from-bottom duration-300">
						{/* Header */}
						...
						<div className="space-y-4">
							<button
								...
								className="flex items-center justify-between p-3 text-[var(--color-stage-sidebar-text)] hover:text-[var(--color-stage-sidebar-text-hover)] hover:bg-white/5 rounded-lg transition-colors w-full text-left"
							>
								Display type
							</button>
							...
							{showHelpAccordion && (
								<div className="ml-4 space-y-2">
									<a
										...
										rel="noopener"
										onClick={() => setShowMobileMenu(false)}
										className="flex items-center justify-between p-2 text-sm text-[var(--color-stage-sidebar-text)] hover:text-[var(--color-stage-sidebar-text-hover)] hover:bg-white/5 rounded-lg transition-colors"
									>
										Docs
							...
							<Link
								href="/apps"
								onClick={() => setShowMobileMenu(false)}
								className="flex items-center justify-between p-3 text-[var(--color-stage-sidebar-text)] hover:text-[var(--color-stage-sidebar-text-hover)] hover:bg-white/5 rounded-lg transition-colors"
							>
								Lobby
							</Link>
							...
							<div className="border-t border-white/10 pt-4">
								<div className="p-3 text-[var(--color-stage-sidebar-text)] hover:text-[var(--color-stage-sidebar-text-hover)] hover:bg-white/5 rounded-lg transition-colors">
