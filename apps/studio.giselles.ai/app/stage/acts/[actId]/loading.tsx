			...
			header={
				<div className="flex items-center gap-[6px]">
					<div className="p-[8px] bg-element-active rounded-[4px]">
						<div className="size-[16px] bg-ghost-element rounded animate-pulse" />
					</div>
					<div className="flex flex-col gap-[4px]">
						<div className="w-32 h-[14px] bg-ghost-element rounded animate-pulse" />
						<div className="flex items-center gap-[4px]">
							<div className="w-12 h-[10px] bg-ghost-element rounded animate-pulse" />
							<div className="size-[2px] rounded-full bg-text-muted animate-pulse" />
							<div className="w-24 h-[10px] bg-ghost-element rounded animate-pulse" />
						</div>
					</div>
				</div>
			}
		>
			...
			<div className="space-y-[16px]">
				...
				<div className="space-y-[8px]">
					<div className="w-full h-[20px] bg-ghost-element rounded animate-pulse" />
					<div className="w-full h-[20px] bg-ghost-element rounded animate-pulse" />
					<div className="w-4/5 h-[20px] bg-ghost-element rounded animate-pulse" />
				</div>
				...
				<div className="space-y-[8px]">
					...
					<div className="ml-[20px] pl-[12px] border-l border-l-border space-y-[4px]">
						<div className="w-full h-[14px] bg-ghost-element rounded animate-pulse" />
						<div className="w-3/4 h-[14px] bg-ghost-element rounded animate-pulse" />
						<div className="w-20 h-[12px] bg-ghost-element rounded animate-pulse" />
					</div>
				</div>
				...
				<div className="space-y-[8px]">
					<div className="w-3/4 h-[14px] bg-ghost-element rounded animate-pulse" />
					<div className="w-3/4 h-[20px] bg-ghost-element rounded animate-pulse" />
				</div>
			</div>
		</StepLayout>
	);
