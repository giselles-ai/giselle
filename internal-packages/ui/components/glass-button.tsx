...
type GlassButtonVariant = "default" | "muted" | "comingSoon" | "currentPlan";
type GlassButtonSize = "default" | "sm" | "lg";
...
export function GlassButton({
	...
	const baseClassName =
		"group relative overflow-hidden rounded-lg text-white transition-all duration-300 hover:scale-[1.01] active:scale-95 inline-flex items-center justify-center gap-1.5 font-sans text-[14px] font-medium cursor-pointer disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:scale-100 disabled:active:scale-100";

	const variantClassName: Record<GlassButtonVariant, string> = {
		default: "",
		muted: "text-white/80",
	...
	const sizeClassName: Record<GlassButtonSize, string> = {
		default: "px-4 py-2",
