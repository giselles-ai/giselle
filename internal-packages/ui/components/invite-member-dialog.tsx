		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent variant="glass" className={className}>
				...
				<DialogBody>
					...
					>
						<div className="flex items-start gap-3 rounded-lg bg-[color-mix(in_srgb,var(--color-text-inverse,var(--color-white,#fff))_5%,transparent)] p-1">
							<div className="flex min-h-[40px] flex-grow flex-wrap items-center gap-1 px-2">
								{emailTags.map((email) => (
									<div
										key={email}
										className="mb-1 mr-2 flex items-center rounded-md bg-[color-mix(in_srgb,var(--color-text-inverse,var(--color-white,#fff))_10%,transparent)] px-2.5 py-1.5"
									>
