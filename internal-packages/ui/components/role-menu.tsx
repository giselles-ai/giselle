			...
			trigger={
				<button
					...
					className={clsx(
						...
						"bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 5%,transparent)] transition-colors hover:bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 10%,transparent)]",
						widthClassName,
						triggerClassName,
					)}
				>
		...
		>
			<PopoverContent>
				<div className={clsx("min-w-[165px] p-1", className)}>
					...
					{canRemove && (
						<>
							<div className="my-2 h-px bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 10%,transparent)]" />
							<button
								type="button"
								onClick={onRemove}
								className={clsx(
