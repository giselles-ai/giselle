	...
	return (
		<div className="h-[600px] w-[320px] flex flex-col relative">
			...
			<div className="flex-1 overflow-y-auto py-2 px-4 flex flex-col relative thin-scrollbar mask-fade-b">
							...
							>
								<div
									className={`max-w-[80%] min-w-0 px-4 py-3 text-sm font-mono ${
										message.sender === "user"
						? "font-light bg-chat-bubble-user text-[var(--color-text-inverse)] rounded-[8px] rounded-br-[4px] shadow-chat-bubble-user"
					: "font-light bg-chat-bubble-accent text-[var(--color-text-inverse)] rounded-[8px] rounded-bl-[4px] border border-chat-bubble-accent shadow-chat-bubble-accent backdrop-blur-sm animate-slide-up-left"
									}`}
								>
				...
				<div className="bg-chat-bubble-accent text-[var(--color-text-inverse)] rounded-[8px] rounded-bl-[4px] px-4 py-3 border border-chat-bubble-accent shadow-chat-bubble-accent backdrop-blur-sm font-mono font-light">
								<div className="flex items-center space-x-1">
									<div className="flex space-x-1">
										<div className="w-1.5 h-1.5 bg-[var(--color-text-inverse, #fff)] rounded-full animate-bounce"></div>
										<div className="w-1.5 h-1.5 bg-[var(--color-text-inverse, #fff)] rounded-full animate-bounce animate-delay-100"></div>
										<div className="w-1.5 h-1.5 bg-[var(--color-text-inverse, #fff)] rounded-full animate-bounce animate-delay-200"></div>
									</div>
								</div>
							</div>
						</div>
