	...
	return (
		<div className="h-[600px] w-[320px] flex flex-col relative">
			...
			<div className="flex-1 overflow-y-auto py-2 px-4 flex flex-col relative thin-scrollbar mask-fade-b">
							...
							>
								<div
									className={`max-w-[80%] min-w-0 px-4 py-3 text-sm font-mono ${
										message.sender === "user"
						? "font-light bg-[color-mix(in_srgb,var(--color-text-inverse,#fff)_10%,transparent)] text-[var(--color-text-inverse)] rounded-[8px] rounded-br-[4px] border border-[color-mix(in_srgb,var(--color-text-inverse,#fff)_20%,transparent)]"
						: "font-light bg-[color-mix(in_srgb,var(--color-text-inverse,#fff)_10%,transparent)] text-[var(--color-text-inverse)] rounded-[8px] rounded-bl-[4px] border border-[color-mix(in_srgb,var(--color-text-inverse,#fff)_20%,transparent)] backdrop-blur-sm animate-slide-up-left"
									}`}
								>
				...
				<div className="bg-[color-mix(in_srgb,var(--color-text-inverse,#fff)_10%,transparent)] text-[var(--color-text-inverse)] rounded-[8px] rounded-bl-[4px] px-4 py-3 border border-[color-mix(in_srgb,var(--color-text-inverse,#fff)_20%,transparent)] backdrop-blur-sm font-mono font-light">
