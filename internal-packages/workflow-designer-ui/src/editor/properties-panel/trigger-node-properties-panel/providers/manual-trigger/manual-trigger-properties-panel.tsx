							...
							>
								...
								>
									<input
										...
										className="w-full rounded-[8px] py-[8px] px-[12px] outline-none focus:outline-none border-none bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 10%,transparent)] text-inverse text-[14px]"
										data-1p-ignore
									/>
								</SettingRow>
