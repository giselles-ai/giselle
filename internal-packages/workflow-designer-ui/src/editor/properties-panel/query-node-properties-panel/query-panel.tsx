									...
									return (
										...
										>
											...
											<button
												...
												className="absolute top-[6px] right-[6px] size-[22px] rounded-full flex items-center justify-center text-secondary hover:text-inverse hover:bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 20%,transparent)] transition-colors"
