					...
					>
						...
						<div className="absolute bottom-[20px] right-[12px]">
							<button
								...
								className="size-[32px] rounded-full bg-[var(--color-text-inverse, #fff)] hover:bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 80%,transparent)] transition-colors flex items-center justify-center"
								onClick={() => {
