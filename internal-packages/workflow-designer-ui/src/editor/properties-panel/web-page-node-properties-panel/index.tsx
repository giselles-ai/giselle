				...
				<form className="flex flex-col gap-[8px]" onSubmit={handleSubmit}>
					<div className="flex flex-col gap-[8px]">
						<textarea
							...
							name="urls"
							className={clsx(
								"w-full min-h-[120px] rounded-[8px] bg-[color-mix(in_srgb,var(--color-text-inverse,#fff)_10%,transparent)] text-[var(--color-text-inverse)] text-[14px] outline-none resize-none border-none",
