									...
									return (
										...
										>
											...
											>
												...
												<Accordion.Content className="markdown-renderer overflow-hidden italic text-[14px] text-[var(--color-text-inverse)] ml-[8px] pl-[12px] mb-[8px] data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown border-l border-l-[color-mix(in_srgb,var(--color-text-inverse,#fff)_20%,transparent)]">
