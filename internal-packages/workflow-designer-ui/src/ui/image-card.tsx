...
export function ImageCard({
	...
	return (
		<div className="relative group cursor-pointer flex-shrink-0 bg-[color-mix(in srgb,var(--color-text-inverse, #fff) 10%,transparent)] rounded-[8px] overflow-hidden h-full">
			<Image
				src={src}
				alt="generated file"
				width={512}
