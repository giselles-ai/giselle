...
export const getglassButtonStyles = () => ({
	boxShadow: glassTokens.effects.shadow.glassButton,
});

export const getglassButtonOuterGlowStyles = () => ({
	backgroundColor: glassTokens.colors.button.glass.outerGlow.color,
	opacity: glassTokens.colors.button.glass.outerGlow.opacity,
});

export const getglassButtonBackgroundStyles = () => ({
	background: glassTokens.colors.button.glass.background,
});

export const getglassButtonTopReflectionStyles = () => ({
	background: `linear-gradient(to right, transparent, ${glassTokens.colors.button.glass.topHighlight}, transparent)`,
});

export const getglassButtonBorderStyles = () => ({
	border: `1px solid ${glassTokens.colors.button.glass.border}`,
});

export const getglassButtonHoverOverlayStyles = () => ({
	background: `linear-gradient(to top, transparent, ${glassTokens.colors.button.glass.hoverOverlay})`,
});
