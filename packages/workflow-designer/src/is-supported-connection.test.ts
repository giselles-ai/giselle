...
describe("isSupportedConnection", () => {
	...
	describe("Vector store node restrictions", () => {
		test("should allow connection from VectorStoreNode to QueryNode", () => {
			const outputNode = createVectorStoreNode("nd-vs-test1");
			const inputNode = createQueryNode("nd-query-test1");
		...
		test("should reject connection from VectorStoreNode to non-QueryNode", () => {
			const outputNode = createVectorStoreNode("nd-vs-test2");
			const inputNode = createTextGenerationNode("nd-text-gen-test1");
	...
	describe("Query node output restrictions", () => {
		test("should allow connection from QueryNode to TextGenerationNode", () => {
			const outputNode = createQueryNode("nd-query-out-1");
			const inputNode = createTextGenerationNode("nd-text-gen-in-1");
		...
		test("should allow connection from QueryNode to ImageGenerationNode", () => {
			const outputNode = createQueryNode("nd-query-out-2");
			const inputNode = createImageGenerationNode("nd-image-gen-in-1");
